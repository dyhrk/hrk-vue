...
import { defineAsyncComponent, ref, reactive, onMounted, nextTick, computed, watch, defineProps } from 'vue';
import initIconfont from '@/utils/getStyleSheets';
import '@/assets/styles/iconSelector.scss';
...
const onIconClick = (pane) => {
	...
	emits('update:modelValue', pane.paneName);
