   ...
   <div class="app-container layout-padding w100">
      <div class="queryCard">
         <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
            <el-form-item label="字典名称" prop="dictName" class="mb20">
               <el-input v-model="queryParams.dictName" placeholder="请输入字典名称" clearable style="width: 240px"
                  @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="字典类型" prop="dictType" class="mb20">
      ...
      <el-card class="table_bord">
         ...
         <el-table v-loading="loading" :data="typeList" style="height: 100%;" @selection-change="handleSelectionChange">
