   ...
   <div class="app-container layout-padding w100">
      <div class="queryCard">
         <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
            <el-form-item label="公告标题" prop="noticeTitle" class="mb20">
               <el-input v-model="queryParams.noticeTitle" placeholder="请输入公告标题" clearable style="width: 200px"
                  @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="操作人员" prop="createBy" class="mb20">
      ...
      <el-card class="table_bord">
         ...
         <el-table v-loading="loading" style="height: 100%;" :data="noticeList"
