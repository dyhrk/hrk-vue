   ...
   <div class="app-container layout-padding w100">
      <div class="queryCard">
         <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
            <el-form-item label="参数名称" prop="configName" class="mb20">
               <el-input v-model="queryParams.configName" placeholder="请输入参数名称" clearable style="width: 240px"
                  @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="参数键名" prop="configKey" class="mb20">
      ...
      <el-card class="table_bord">
         ...
         <el-table v-loading="loading" style="height: 100%;" :data="configList" @selection-change="handleSelectionChange">
