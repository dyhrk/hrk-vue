...
// const { settingsConfig } = storeToRefs(storesThemeConfig);
...
const initPieChart = () => {
	...
	const option = {
			...
			elements: [
				{
					...
					z: -1,
					style: {
						image: settingsConfig.value.isIsDark
							? ''
		...
		series: [
			{
				type: 'pie',
				radius: ['82', settingsConfig.value.isIsDark ? '50' : '102'],
				center: ['32%', '50%'],
				itemStyle: {
