   ...
   <div class="app-container layout-padding w100">
      <div class="queryCard">
         <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
            <el-form-item label="登录地址" prop="ipaddr" class="mb20">
               <el-input v-model="queryParams.ipaddr" placeholder="请输入登录地址" clearable style="width: 240px;"
                  @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="用户名称" prop="userName" class="mb20">
            ...
            <el-form-item label="登录时间" style="width: 308px" class="mb20 mr10">
